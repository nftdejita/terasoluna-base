package com.example.config.app.mybatis;
...
public class MybatisConfig {
    ...
    private static void setTypeAliases(TypeAliasRegistry typeAliasRegistry) {
        typeAliasRegistry.registerAliases("com.example.domain.model");
        typeAliasRegistry.registerAliases(
                "com.example.domain.repository");
        // typeAliasRegistry.registerAliases("com.example.infra.mybatis.typehandler");
    }
    ...
    private static void setTypeHandlers(
        ...
        // typeHandlerRegistry.register("com.example.infra.mybatis.typehandler");
    }
}
